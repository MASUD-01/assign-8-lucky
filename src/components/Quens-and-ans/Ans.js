...
const Ans = () => {
    return (
        <div className='p-4'>
            ...
            <p>Ans:State is the local state of the component which cannot  access and modified outside of the component. It's related to local variables in a function.props can send value. Props make components reusable by giving components the ability to receive data from their parent component in the form of props.</p>
        </div>
    );
};
